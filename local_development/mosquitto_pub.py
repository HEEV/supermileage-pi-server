...
client = mqtt.Client(
    mqtt.CallbackAPIVersion.VERSION2, "test_publisher", reconnect_on_failure=True, transport="websockets"
...
client.publish(getenv("MQTT_SUBSCRIBE_TOPIC", "cars/sting/data"), getenv("TEST_MQTT_MESSAGE", "Test message"), qos=0)  # Publish a test message
