...
@pytest.mark.asyncio
async def test_disable_display_blocks_socket_emit(mock_dependencies, default_env, mock_mqtt_client):
...
@pytest.mark.asyncio
async def test_enable_display_allows_socket_emit(mock_dependencies, default_env, mock_mqtt_client):
...
@pytest.mark.asyncio
async def test_disable_local_blocks_csv_write(mock_dependencies, default_env, mock_mqtt_client):
...
@pytest.mark.asyncio
async def test_enable_local_allows_csv_write(mock_dependencies, default_env, mock_mqtt_client):
